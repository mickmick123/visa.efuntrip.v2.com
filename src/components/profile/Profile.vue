        ...
        <VaCard :bordered="false">
            ...
            <VaCardContent>
                ...
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                    ...
                    <VaInput v-model="client.passport_exp_date" label="Passport Expiration" readonly class="mb-6"  placeholder="N/A" />
                    <VaInput v-model="client.visa_type" label="Visa Type" readonly class="mb-6"  placeholder="N/A" />
                    <VaTextarea  class="col-span-4" v-model="client.address" label="Address" readonly placeholder="Empty address" />
                </div>
        ...
        <VaCard square outlined>
            ...
            <VaCardContent>
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 items-end">
                    ...
                    <VaInput v-model="client.total_complete_service_cost" label="Total Complete Service Cost" readonly class="mb-6" placeholder="N/A"/>
                    ...
                    <VaInput v-model="client.total_refund" label="Total Withdrawal Amount" readonly class="mb-6" placeholder="N/A"/>
                    <VaInput v-model="client.total_discount" label="Total Promo Availed" readonly class="mb-6" placeholder="N/A"/>
                </div>
